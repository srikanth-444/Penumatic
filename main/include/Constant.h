...
#define ADC2_CS_PIN 5
#define ADC3_CS_PIN 6
#define ACTUATOR_CS_PIN 7
#define MOTOR_CS_PIN 15

#define MOTOR_STATE_ORDER (uint16_t[]){0x0021, 0x0102, 0x0120, 0x0201, 0x0220, 0x0202}
